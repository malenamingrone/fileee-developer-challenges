...
public class EmployeeController {
    ...
    @GetMapping("/{id}")
    public Employee getEmployee(@PathVariable Long id) throws Exception { // TODO: handle exception
    ...
    @PutMapping("/{id}")
    public Employee updateEmployee(@PathVariable Long id, Employee employee) throws Exception { // TODO: handle exception
        return employeeService.update(id, employee);
    }

    @DeleteMapping("/{id}")
    public Employee removeEmployee(@PathVariable Long id) throws Exception { // TODO: handle exception
        return employeeService.delete(id);
    }

    @GetMapping("/{id}/worklog")
    public List<Worklog> listWorklog(@PathVariable Long id) throws Exception { // TODO: handle exception
        employeeService.exists(id);
        return worklogService.getByEmployee(id);
    }

    @PostMapping("/{id}/worklog")
    public Worklog addWorklog(@PathVariable Long id, @RequestBody Worklog worklog) throws Exception { // TODO: handle exception
        employeeService.exists(id);
